...
@description: Trains and evaluate an Incremental Spatio Temporal Learner (ISTL)
				model by using the UCSD Ped train and test sets by using a
				validations set and the learning ate improver schedule.

@usage: train_ISTL_UCSDPed1_noAct_noFed_cons_val.py -d <JSON document experiment> [-s]
"""
